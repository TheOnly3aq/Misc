...
Charge_Config = {
	Locations = {
		{ name = "Charging Station", id = 361, r = 4.0, x = 153.4138,  y = 6592.721,  z = 30.8449 },
		{ name = "Charging Station", id = 361, r = 4.0, x = 2697.205,  y = 3277.662,  z = 54.24057 },
		{ name = "Charging Station", id = 361, r = 4.0, x = 2683.23,   y = 3253.071,  z = 54.24057 },
		{ name = "Charging Station", id = 361, r = 4.0, x = -2534.736, y = 2345.22,   z = 32.05991 },
...
Config.Frozen = false     --Do you want the peds to be unable to move? It's probably a yes, so leave true in there.
...
Config.PedList = {
	...
	{
		model = "s_m_y_xmech_02",
		coords = vector3(1769.70, 3323.55, 41.44), --flywheels
		heading = 205.71,
		gender = "male",
		animName = "work_base",
		isRendered = false,
...
Stall_Config = {
	...
	DizzyEffectDuration = 5, -- in seconds
	MinHealthDifference = 5,
	DizzyEffectIntensity = 0,
}
